...
class TestTaskManagement:
    ...
    def test_analyze_task_with_agent(self, mock_run, example_project_config):
    ...
    @patch("workspace.core.task.update_task_plan")
    def test_execute_subtask_sequential(self, mock_update, mock_create, example_task, global_config, example_project_config):
